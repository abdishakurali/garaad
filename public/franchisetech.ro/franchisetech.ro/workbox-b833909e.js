define(["exports"], function(t) {
    ...
    function x(t) {
        return t !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (m || (m = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t) ? function(...e) {
    ...
    function L(t) {
        return "function" == typeof t ? x(t) : (t instanceof IDBTransaction && function(t) {
            if (v.has(t)) return;
            ...
            v.set(t, e)
        }(t), e = t, (g || (g = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some(t => e instanceof t) ? new Proxy(t, U) : t);
        var e
    }
    ...
    class j {
        constructor(t, e = {}) {
            this.R = !1, this.v = !1, this.q = e.maxEntries, this.D = e.maxAgeSeconds, this.U = e.matchOptions, this.u = t, this._ = new T(t)
        }
        async expireEntries() {
    ...
    class P {
        ...
        isResponseCacheable(t) {
            let e = !0;
            return this.L && (e = this.L.includes(t.status)), this.I && e && (e = Object.keys(this.I).some(e => t.headers.get(e) === this.I[e])), e
        }
    }
    ...
    class A {
        constructor(t, e) {
            this.C = {}, Object.assign(this, e), this.event = e.event, this.N = t, this.O = new S, this.B = [], this.k = [...t.plugins], this.M = new Map;
        ...
        async cacheMatch(t) {
            ...
            const {
                cacheName: n,
                matchOptions: i
            } = this.N, r = await this.getCacheKey(e, "read"), a = Object.assign(Object.assign({}, i), {
                cacheName: n
            });
        ...
        async cachePut(t, e) {
            ...
            const {
                cacheName: c,
                matchOptions: h
            } = this.N, u = await self.caches.open(c), l = this.hasCallback("cacheDidUpdate"), f = l ? await async function(t, e, s, n) {
                const i = W(e.url, s);
                ...
                const r = Object.assign(Object.assign({}, n), {
                    ...
                    a = await t.keys(e, r);
                for (const e of a)
                    if (i === W(e.url, s)) return t.match(e, n)
        ...
        async getCacheKey(t, e) {
            ...
            if (!this.C[s]) {
                let n = t;
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed")) n = K(await t({
                    mode: e,
                    request: n,
                    event: this.event,
                    params: this.params
    ...
    class F {
        ...
        async j(t, e, n) {
            ...
            try {
                if (i = await this.W(e, t), !i || "error" === i.type) throw new s("no-response", {
                    url: e.url
                })
            } catch (s) {
    ...
    class X extends F {
        constructor(t = {}) {
            t.cacheName = f(t.cacheName), super(t), this.K = !1 !== t.fallbackToNetwork, this.plugins.push(X.copyRedirectedCacheableResponsesPlugin)
        }
        async W(t, e) {
        ...
        async F(t, e) {
            let n;
            const i = e.params || {};
            if (!this.K) throw new s("missing-precache-entry", {
    ...
    class Y {
        constructor({
            ...
            this.$ = new Map, this.G = new Map, this.V = new Map, this.N = new X({
                cacheName: f(t),
                plugins: [...e, new V({
        ...
        addToCacheList(t) {
            ...
            for (const n of t) {
                ...
                if (this.$.has(i) && this.$.get(i) !== t) throw new s("add-to-cache-list-conflicting-entries", {
                    firstEntry: this.$.get(i),
                    secondEntry: t
                });
                if ("string" != typeof n && n.integrity) {
                    if (this.V.has(t) && this.V.get(t) !== n.integrity) throw new s("add-to-cache-list-conflicting-integrities", {
                        url: i
                    });
    ...
    t.CacheFirst = class extends F {
        ...
        constructor(t) {
            this.cacheWillUpdate = async ({
                response: t
            }) => this.X.isResponseCacheable(t) ? t : null, this.X = new P(t)
        }
        ...
        constructor(t = {}) {
            ...
            }, this.tt = t, this.D = t.maxAgeSeconds, this.et = new Map, t.purgeOnQuotaError && function(t) {
                p.add(t)
