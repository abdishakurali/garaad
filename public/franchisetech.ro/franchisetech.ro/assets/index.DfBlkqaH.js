...
const j = () => {
    ...
    h = e => e ? typeof e == "string" ? {
        publicKey: e
    } : e.toString() === "[object Object]" ? e : {} : {},
    L = (e, t = "https://api.emailjs.com") => {
        if (!e) return;
        const r = h(e);
        s.publicKey = r.publicKey, s.blockHeadless = r.blockHeadless, s.storageProvider = r.storageProvider, s.blockList = r.blockList, s.limitRate = r.limitRate, s.origin = r.origin || t
    },
    f = async (e, t, r = {}) => {
        const o = await fetch(s.origin + e, {
                method: "POST",
                headers: r,
                body: t
            }),
    ...
    g = e => e.webdriver || !e.languages || e.languages.length === 0,
    w = () => new c(451, "Unavailable For Headless Browser"),
    R = (e, t) => {
    ...
    S = (e, t) => e instanceof FormData ? e.get(t) : e[t],
    y = (e, t) => {
        if (H(e)) return !1;
        R(e.list, e.watchVariable);
        const r = S(t, e.watchVariable);
        return typeof r != "string" ? !1 : e.list.includes(r)
    },
    v = () => new c(403, "Forbidden"),
    V = (e, t) => {
    ...
    F = async (e, t, r) => {
        const o = Number(await r.get(e) || 0);
        return t - Date.now() + o
    },
    k = async (e, t, r) => {
        ...
        V(t.throttle, t.id);
        const o = t.id || e;
        return await F(o, t.throttle, r) > 0 ? !0 : (await r.set(o, Date.now().toString()), !1)
    },
    P = () => new c(429, "Too Many Requests"),
    _ = async (e, t, r, o) => {
        const i = h(o),
            a = i.publicKey || s.publicKey,
            l = i.blockHeadless || s.blockHeadless,
            m = i.storageProvider || s.storageProvider,
            d = { ...s.blockList,
                ...i.blockList
            },
            u = { ...s.limitRate,
        ...
        return l && g(navigator) ? Promise.reject(w()) : (p(a, e, t), T(r), r && y(d, r) ? Promise.reject(v()) : await k(location.pathname, u, m) ? Promise.reject(P()) : f("/api/v1.0/email/send", JSON.stringify({
            lib_version: "4.4.1",
            user_id: a,
            service_id: e,
            template_id: t,
    ...
    B = e => typeof e == "string" ? document.querySelector(e) : e,
    E = async (e, t, r, o) => {
        const i = h(o),
            a = i.publicKey || s.publicKey,
            l = i.blockHeadless || s.blockHeadless,
            m = s.storageProvider || i.storageProvider,
            d = { ...s.blockList,
                ...i.blockList
            },
            u = { ...s.limitRate,
        ...
        if (l && g(navigator)) return Promise.reject(w());
        const b = B(r);
        p(a, e, t), K(b);
        const n = new FormData(b);
        return y(d, n) ? Promise.reject(v()) : await k(location.pathname, u, m) ? Promise.reject(P()) : (n.append("lib_version", "4.4.1"), n.append("service_id", e), n.append("template_id", t), n.append("user_id", a), f("/api/v1.0/email/send-form", n))
    },
    O = {
        init: L,
        send: _,
        sendForm: E,
        EmailJSResponseStatus: c
    };
export {
    O as e
};