            ...
            <div className="p-8 flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-black text-foreground mb-2">
                {pathname.includes("/community") ? "Bulshadda" :
                 ...
                 pathname.includes("/cohorts") ? "Kooxaha" : "Casharrada Xidhan"}
              </h2>

              <p className="text-muted-foreground text-sm mb-6">
                Ku biir Mentorship-ka si aad u hesho:
              </p>

              {/* Membership Benefits */}
              <ul className="text-left space-y-3 mb-8 w-full max-w-xs">
                {[
                  "Macallin shakhsiyeed oo kuu qaabilsan",
                  "Helitaanka bulshadda khabiirada ah",
                  "Mashaariic dhab ah oo portfolio loogu isticmaalo",
                ].map((benefit, i) => (
              ...
              <div className="mb-8">
                ...
                <span className="text-muted-foreground ml-2 font-medium">/bilkiiba</span>
              </div>
              ...
              {isUrgent && (
                <div className="mb-6 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 text-xs font-bold animate-pulse">
                  ⚠️ Boosaaska macalinka waa xaddidan yihiin
                </div>
              )}
