...
export function FooterSection() {
  const navigation = {
    product: [
      { name: 'Koorsooyin', href: '#' },
      { name: 'Qiimeyn', href: '#' },
      { name: 'Markhaati', href: '#' },
      { name: 'Caawimo', href: '#' },
    ],
    company: [
      { name: 'Nagu saabsan', href: '#' },
      { name: 'Shaqo', href: '#' },
    ...
    <footer className="bg-black text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="mt-16 border-t border-gray-800 pt-10">
          ...
          <p className="mt-8 text-xs text-gray-400 text-center sm:text-left">© Garaad, Org. Barnaamijku waa mid loogu talagalay dadka Soomaaliyeed, isagoo diiradda saaraya STEM.</p>
        </div>
      </div>
    </footer>
  );
