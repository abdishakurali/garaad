            ...
            <div className="max-w-5xl mx-auto px-4">
                ...
                >
                    <div className="relative shrink-0">
                        ...
                        {Icon && (
                            <div className="absolute -bottom-2 -right-2 w-10 h-10 rounded-full bg-primary flex items-center justify-center shadow-lg border-2 border-white dark:border-zinc-800">
